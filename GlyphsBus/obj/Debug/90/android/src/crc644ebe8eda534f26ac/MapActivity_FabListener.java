...
public class MapActivity_FabListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GlyphsBus.MapActivity+FabListener, GlyphsBus", MapActivity_FabListener.class, __md_methods);
	}


	public MapActivity_FabListener ()
	{
		super ();
		if (getClass () == MapActivity_FabListener.class)
			mono.android.TypeManager.Activate ("GlyphsBus.MapActivity+FabListener, GlyphsBus", "", this, new java.lang.Object[] {  });
	}

	public MapActivity_FabListener (android.view.View[] p0)
	{
		super ();
		if (getClass () == MapActivity_FabListener.class)
			mono.android.TypeManager.Activate ("GlyphsBus.MapActivity+FabListener, GlyphsBus", "Android.Views.View[], Mono.Android", this, new java.lang.Object[] { p0 });
	}
