...
public class CamActivity_FabListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GlyphsBus.CamActivity+FabListener, GlyphsBus", CamActivity_FabListener.class, __md_methods);
	}


	public CamActivity_FabListener ()
	{
		super ();
		if (getClass () == CamActivity_FabListener.class)
			mono.android.TypeManager.Activate ("GlyphsBus.CamActivity+FabListener, GlyphsBus", "", this, new java.lang.Object[] {  });
	}

	public CamActivity_FabListener (android.view.View[] p0)
	{
		super ();
		if (getClass () == CamActivity_FabListener.class)
			mono.android.TypeManager.Activate ("GlyphsBus.CamActivity+FabListener, GlyphsBus", "Android.Views.View[], Mono.Android", this, new java.lang.Object[] { p0 });
	}
