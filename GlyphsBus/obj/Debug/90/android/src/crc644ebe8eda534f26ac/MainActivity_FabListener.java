package crc644ebe8eda534f26ac;


public class MainActivity_FabListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GlyphsBus.MainActivity+FabListener, GlyphsBus", MainActivity_FabListener.class, __md_methods);
	}


	public MainActivity_FabListener ()
	{
		super ();
		if (getClass () == MainActivity_FabListener.class)
			mono.android.TypeManager.Activate ("GlyphsBus.MainActivity+FabListener, GlyphsBus", "", this, new java.lang.Object[] {  });
	}

	public MainActivity_FabListener (android.view.View[] p0)
	{
		super ();
		if (getClass () == MainActivity_FabListener.class)
			mono.android.TypeManager.Activate ("GlyphsBus.MainActivity+FabListener, GlyphsBus", "Android.Views.View[], Mono.Android", this, new java.lang.Object[] { p0 });
	}
