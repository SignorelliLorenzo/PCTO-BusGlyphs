...
public class BusActivity_FabListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GlyphsBus.BusActivity+FabListener, GlyphsBus", BusActivity_FabListener.class, __md_methods);
	}


	public BusActivity_FabListener ()
	{
		super ();
		if (getClass () == BusActivity_FabListener.class)
			mono.android.TypeManager.Activate ("GlyphsBus.BusActivity+FabListener, GlyphsBus", "", this, new java.lang.Object[] {  });
	}

	public BusActivity_FabListener (android.view.View[] p0)
	{
		super ();
		if (getClass () == BusActivity_FabListener.class)
			mono.android.TypeManager.Activate ("GlyphsBus.BusActivity+FabListener, GlyphsBus", "Android.Views.View[], Mono.Android", this, new java.lang.Object[] { p0 });
	}
